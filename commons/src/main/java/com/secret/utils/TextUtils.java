...
public class TextUtils {
     ...
     */
    public static final String dealNull(String str, String defaultStr) {
     ...
     * @return 非空时返回原值<br>否则返回默认值
     */
    public static final String dealNull(Object obj, String defaultStr) {
     ...
     * <br>true为非空
     */
    private static boolean strSet(Object obj) {
