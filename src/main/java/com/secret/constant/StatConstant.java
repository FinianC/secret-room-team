...
public interface StatConstant {
	...
	/**
	 * 网站访问量（key+ip）
	 * {@link StatInterceptor#preHandle(HttpServletRequest, HttpServletResponse, Object)}
	 */
	String VISIT_COUNT = "visitCount:";

	/**
	 * 注册量(inc)
	 * {@link UctrMemberController#register(RegisterParam)}
	 */
	 ...
	 * {@link ContentController#getVideoPlayAuth(Integer, Integer, String)}
	 */
	String VIDEO_VIEW_COUNT = "videoViewCount:";

	/**
	 * 课程订阅量(inc)
	 * {@link ContentController#orderPaySucceed(String, HttpServletRequest)}
	 */
